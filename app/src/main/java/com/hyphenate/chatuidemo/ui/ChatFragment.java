...
import com.easemob.redpacket.widget.RandomPacketPresenter;
import com.easemob.redpacket.widget.RedPacketAckPresenter;
import com.easemob.redpacket.widget.RedPacketPresenter;
...
import com.hyphenate.chatuidemo.widget.CallPresenter;
import com.hyphenate.chatuidemo.widget.RecallPresenter;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
        ...
        if (requestCode == REQUEST_CODE_CONTEXT_MENU) {
            switch (resultCode) {
                ...
                case ContextMenuActivity.RESULT_CODE_DELETE: // delete
                    getConversation().removeMessage(contextMenuMessage.getMsgId());
                    notifyMessageRemoved(contextMenuMessage);
                    break;
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                msgNotification.setMsgId(contextMenuMessage.getMsgId());
                                ...
                                notifyMessageUpdate(msgNotification);
    ...
    private final class CustomChatRowProvider implements EaseCustomChatRowProvider {
        ...
        @Override
        public int getItemViewType(EMMessage message) {
        ...
        @Override
        public BasePresenter createPresenterByViewType(final int viewType) {
//            if(message.getType() == EMMessage.Type.TXT){
...
//            return null;
            ...
            switch (viewType) {
                case MESSAGE_TYPE_RECV_VOICE_CALL:
                    return new CallPresenter(getContext(), R.layout.ease_row_received_voice_call);
                case MESSAGE_TYPE_SENT_VOICE_CALL:
                    return new CallPresenter(getContext(), R.layout.ease_row_sent_voice_call);
                case MESSAGE_TYPE_RECV_VIDEO_CALL:
                    return new CallPresenter(getContext(), R.layout.ease_row_received_video_call);
                case MESSAGE_TYPE_SENT_VIDEO_CALL:
                    return new CallPresenter(getContext(), R.layout.ease_row_sent_video_call);
                case MESSAGE_TYPE_RECALL:
                    return new RecallPresenter(getContext(), R.layout.em_row_recall_message);
                case MESSAGE_TYPE_RECV_RANDOM:
                    return new RandomPacketPresenter(getContext(), R.layout.em_row_received_random_packet);
                case MESSAGE_TYPE_SEND_RANDOM:
                    return new RandomPacketPresenter(getContext(), R.layout.em_row_sent_random_packet);
                case MESSAGE_TYPE_RECV_RED_PACKET:
                    return new RedPacketPresenter(getContext(), R.layout.em_row_received_red_packet);
                case MESSAGE_TYPE_SEND_RED_PACKET:
                    return new RedPacketPresenter(getContext(), R.layout.em_row_sent_red_packet);
                case MESSAGE_TYPE_RECV_RED_PACKET_ACK:
                    return new RedPacketAckPresenter(getContext(), R.layout.em_row_red_packet_ack_message);
                case MESSAGE_TYPE_SEND_RED_PACKET_ACK:
                    return new RedPacketAckPresenter(getContext(), R.layout.em_row_red_packet_ack_message);
            }
            return null;
        }
