...
public class RedPacketAckPresenter extends LayoutPresenter {
    private static final String TAG = "RedPacketAckPresenter";

    public RedPacketAckPresenter(Context context, @LayoutRes int layoutId) {
    ...
    protected LayoutChatRow onCreateChatRow(Context context, @LayoutRes final int layoutId) {
        return new RedPacketAckChatRow(context, layoutId);
    }
}
